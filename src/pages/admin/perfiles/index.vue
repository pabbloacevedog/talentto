		...
		>
			<q-card class="modales text-white">
				...
				<q-card-section align="center" v-else>
					<div class="text-h5 titulo_crear" color="text">
						Nuevo Perfil
					</div>
				</q-card-section>
				<q-card-section
					...
					<div class="row">
						<div class="col-6" style="padding: 1% 7%;">
							...
							<q-select
								...
								standout
								required
								v-model="nuevo_path_default"
								:options="select_path_default"
						...
						<div class="col-6" style="padding:1% 3% 0%;">
							<div class="row ">
								...
								<div class="col-2 text-subtitle1 titulo_crear">
									Asignado
								</div>
							</div>
							<div
