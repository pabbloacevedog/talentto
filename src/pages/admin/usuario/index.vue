<template>
	<div>
		...
		>
			<q-card
				class="modales"
				style="width: 700px; max-width: 80vw !important"
				color="primary"
			>
					...
					<div class="row">
						<div class="col-6">
							...
							<q-select
								...
								standout
								required
								v-model="nuevo_perfil"
								:options="select_perfil"
								label="Perfil"
								class="input-reg q-mx-lg"
							/>
							<q-input
						...
						<div class="col-6">
							...
							<q-input
								...
								required
								label="Producto"
								v-model="nuevo_producto_empresa"
								class="input-reg q-mx-lg"
							>
							</q-input>
							<q-input
					...
					<div class="row">
						...
						<div class="col-6">
							...
							<q-input
								...
								required
								label="Producto"
								v-model="editar_producto_empresa"
								class="input-reg q-mx-lg"
							>
							</q-input>
							<q-input
							...
							<q-select
								...
								standout
								required
								v-model="editar_suscrito_mail"
								:options="estados_suscrito"
